...
$router->group(['middleware' => ['web'], 'prefix' => 'api', 'namespace' => 'Api'], function (Router $router) {
    ...
    $router->group(['middleware' => ['role:lab|student'], 'prefix' => 'user'], function (Router $router) {
        ...
        $router->group(['prefix' => 'loan'], function (Router $router) {
            ...
            $router->get('classrooms/{date}', ['as' => 'api.user.loan.class.list', 'uses' => 'User\LoanController@indexClassroomBorrow']);
    ...
    $router->group(['middleware' => ['role:manager'], 'prefix' => 'manager'], function (Router $router) {
        ...
        $router->group(['prefix' => 'loan'], function (Router $router) {
            ...
            $router->get('classrooms/{date}', ['as' => 'api.man.loan.class.accepted', 'uses' => 'Manager\LoanController@indexClassroomBorrow']);
        ...
        $router->group(['prefix' => 'user'], function (Router $router) {
            ...
            $router->post('import', ['as' => 'api.man.user.import', 'uses' => 'Manager\UserController@import']);
        });
    });
});
