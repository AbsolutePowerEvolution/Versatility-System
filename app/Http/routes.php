...
$router->group(['prefix' => 'api', 'namespace' => 'Api'], function (Router $router) {
    ...
    $router->group(['prefix' => 'manager', 'as' => 'api.manager'], function (Router $router) {
        ...
        $router->group(['prefix' => 'property', 'as' => 'api.man.property'], function ($router) {
        ...
        $router->group(['prefix' => 'repair', 'as' => 'api.man.repair'], function ($router) {
        ...
        $router->group(['prefix' => 'loan', 'as' => 'api.man.loan'], function ($router) {
        ...
        $router->group(['prefix' => 'setting', 'as' => 'api.man.setting'], function ($router) {
